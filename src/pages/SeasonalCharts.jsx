    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="flex h-[calc(100vh-80px)]">
        <div className="w-56 bg-gray-900 border-r border-gray-800 p-4 overflow-y-auto">
          ...
          <div className="space-y-2 mb-4">
            {savedAnalyses.length === 0 ? (
              <div className="text-xs text-gray-400">No saved analyses</div>
            ) : (
              savedAnalyses.map((analysis) => (
                <button
                  ...
                  className="w-full text-left text-xs bg-gray-800 hover:bg-gray-700 rounded px-2 py-2 text-gray-200"
                >
                  {analysis.name}
                </button>
              ))
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex-1 bg-gray-950 p-4 min-h-0">
            {chartData.length === 0 ? (
